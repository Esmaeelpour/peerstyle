...
![custom_style](gallery/custom_style.png?v=5){ width="500" }
...
![ieee](gallery/ieee.png?v=5){ width="500" }
...
![nature](gallery/nature.png?v=5){ width="500" }
...
![poster](gallery/poster.png?v=5){ width="500" }
...
![despine](gallery/despine.png?v=5){ width="500" }
...
![notebook](gallery/notebook.png?v=5){ width="500" }
...
![bright](gallery/bright.png?v=5){ width="500" }
...
![muted](gallery/muted.png?v=5){ width="500" }
...
![grayscale](gallery/grayscale.png?v=5){ width="500" }
