...
![custom_style](gallery/custom_style.png){ width="500" }
...
![ieee](gallery/ieee.png){ width="500" }
...
![nature](gallery/nature.png){ width="500" }
...
![poster](gallery/poster.png){ width="500" }
...
![despine](gallery/despine.png){ width="500" }
...
![notebook](gallery/notebook.png){ width="500" }
...
![bright](gallery/bright.png){ width="500" }
...
![muted](gallery/muted.png){ width="500" }
...
![grayscale](gallery/grayscale.png){ width="500" }
